...
L.push(`| 반사 | 적의 공격이 내 체력을 깎을 때마다 그 적에게 N 피해(적 방어도로 막힘). **전투 내내 남는다** | ${list('reflect')} |`);
...
L.push('힘과 반사는 나와 적이 **같은 것**을 쓴다 — B절에 함께 적었다. 예고 갈래의 \'강화\'는');
...
for (const [k, ko, txt] of [
  ...
  ['regen', '재생', '자기 차례마다 회복'],
  ['reflect', '반사', '맞으면 그만큼 되돌려준다 (전투 내내)'],
