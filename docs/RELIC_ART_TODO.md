# 유물 아이콘 — 20/32 완료 (v3.64)

> **들어온 것** `docs/relics_done.png` 참고. 늑대 이빨 · 빵부스러기 · 붉은 실타래 · 따뜻한 우유 · 마른 장작 ·
> 가죽 장갑 · 까마귀 깃털 · 사냥꾼의 부적 · 가계부 · 이끼 나침반 · 은저울 · 수지 양초 · 오래된 뼈 ·
> 유리병 속 반딧불 · 늑대 가죽 · 독사과 조각 · 길표 · 문지기의 빗장 · 네잎클로버 · 도토리 부적.
> 전부 `assets/relics/` 에 굽고 `RELIC_ART_READY` 에 올렸다.
>
> **아직 없는 12종** 꿀단지 · 붉은 망토 · 숫돌 · 사냥꾼의 눈 · 은식칼 · 은탄환 · 운명의 골무 ·
> 늑대달 목걸이 · 할머니의 동화책 · 곰의 등 · 말라붙은 심장 · 거머리 반지.
> (꿀단지 · 붉은 망토 · 숫돌 · 사냥꾼의 눈은 그림이 나왔는데 파일이 안 넘어왔다 — 다시 올려 주면 바로 넣는다)
>
> 까마귀 깃털만 평균 밝기 23 으로 낮다. 검은 깃털이라 어쩔 수 없는 값이고 화면에서는 윤곽으로 읽힌다.
