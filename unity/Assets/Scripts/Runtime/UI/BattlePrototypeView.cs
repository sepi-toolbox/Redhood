...
namespace Redhood.UI
{
    ...
    public sealed class BattlePrototypeView : MonoBehaviour
    {
        ...
        private Text _enemyLabel, _turnLabel, _message, _rollLabel;
        ...
        private void BuildScreen()
        {
            ...
            Label(_page, "Practice badge", "UNITY · 족보 연습", 20, 58, 350, 20, 12, _ivory, TextAnchor.MiddleCenter);
            _turnLabel = Label(_page, "Turn", "", 20, 87, 350, 22, 14, _ivory, TextAnchor.MiddleCenter);
            Art(_page, "Wolf", "enemies/wolf", 96, 116, 198, 180, true);
            _enemyLabel = Label(_page, "Enemy name", "", 20, 295, 350, 24, 17, _ivory, TextAnchor.MiddleCenter);
            Panel(_page, "HP track", 52, 326, 286, 8, new Color(0.08f, 0.06f, 0.05f));
            _hpFill = Panel(_page, "HP", 52, 326, 286, 8, new Color(0.68f, 0.13f, 0.14f));
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                _diceLabels[i] = Label(_diceButtons[i].transform, "Selection", "", 0, 60, 68, 20,
                    11, _ivory, TextAnchor.MiddleCenter);
            }
            ...
            _next = PaperButton(_page, "Next", "다음 턴", 20, 724, 350, 40, NextTurn, out _, true);
            _message = Label(_page, "Feedback", "", 20, 772, 350, 27, 13, _ivory, TextAnchor.MiddleCenter);
            Label(_page, "Scope", "연습 모드 · 모든 기본 족보 개방 · 적 행동 / 변형 미구현",
        ...
        private void Roll()
        {
            ...
            _selected = null;
            _message.text = "족보를 고르거나, 다시 굴릴 주사위를 탭하세요.";
            Refresh();
        }
        ...
        private void Confirm()
        {
            ...
            _message.text = _battle.IsVictory ? $"승리! {name} · {damage} 피해" : $"{name} · {damage} 피해";
            _selected = null;
            Refresh();
        }
        ...
        private void Refresh()
        {
            ...
            _turnLabel.text = _battle.IsVictory ? "연습 완료" : $"TURN {_battle.Turn:00}";
            ...
            _confirm.gameObject.SetActive(_battle.Phase != BattlePhase.TurnComplete);
            ...
            _next.gameObject.SetActive(_battle.Phase == BattlePhase.TurnComplete);
        }
